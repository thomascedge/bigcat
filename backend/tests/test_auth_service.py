...
class TestAuthService():
    ...
    def test_authenticate_user(self, test_user, db_session):
    ...
    def test_login_for_access_token(self, test_user, db_session):
        db_session['user'].insert_one(test_user.model_dump())
...
async def test_register_user(db_session):
    ...
    user = db_session['user'].find_one({'email': 'new@example.com'})
    user = User(**user)
