...
class TestSeatsService:
    ...
    def test_create_seats(self, test_user, test_seat, test_seat_2, db_session):
        ...
        assert any(seat.uid == test_seat.uid for seat in created_seats)
        assert any(seat.uid == test_seat_2.uid for seat in created_seats)
    ...
    def test_edit_seat(self, test_user, test_seat, test_seat_2, db_session):
        ...
        updated_seat = seats_service.edit_seat(test_user, test_seat, test_seat_2, db_session)
    ...
    def test_delete_seat(self, test_user, test_seat, db_session):
        ...
        assert db_session['seat'].find(test_seat.model_dump()) is None
